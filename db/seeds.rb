...
islands = [
  ...
  '契島', '生野島', '大崎上島', '大崎下島', '長島（広島）', '三角島', '豊島', '斎島', '大芝島',
  '上蒲刈島', '下蒲刈島', '情島（広島）', '似島', '金輪島', '江田島・能美島', '沖野島', '倉橋島', '鹿島（広島）', '厳島', '阿多田島',
  '端島', '柱島', '黒島（山口）', '屋代島', '笠佐島', '前島（山口）', '浮島', '情島（山口）', '沖家室島', '平郡島', '長島（山口）',
  '八島', '祝島', '佐合島', '馬島（山口）', '牛島', '笠戸島', '粭島', '大津島', '野島', '向島（山口）', '竹ノ子島', '彦島', '見島', '相島（山口）',
  '櫃島', '大島（山口）', '青海島', '角島', '蓋井島', '六連島',
  # 四国
  '大毛島', '島田島', '伊島', '出羽島', '竹ヶ島',
  '小豆島', '沖之島（香川）', '小豊島', '豊島', '直島', '向島（香川）', '屏風島', '大島（香川）', '男木島', '女木島', '櫃石島',
  '岩黒島', '与島', '小与島', '牛島', '本島', '広島', '手島', '小手島', '高見島', '佐柳島', '粟島（香川）', '志々島', '伊吹島',
  '魚島', '高井神島', '弓削島', '佐島', '生名島', '岩城島', '赤穂根島', '大三島', '伯方島', '鵜島', '大島（今治）', '津島', '岡村島',
  '小大下島', '大下島', '来島', '小島', '馬島（愛媛）', '比岐島', '新居大島', '安居島', '興居島', '釣島', '野忽那島', '睦月島', '中島（愛媛）',
  '怒和島', '津和地島', '二神島', '青島（愛媛）', '大島（八幡浜）', '九島', '嘉島', '戸島', '日振島', '竹ケ島',
  '中ノ島（高知）', '戸島', '柏島', '大島（高知）', '鵜来島', '沖の島',
  # 九州
  ...
  '水納島（本部）', '平安座島', '宮城島（うるま）', '伊計島', '浜比嘉島', '津堅島', '久高島', '奥武島（南城）', '奥武島（南城）',
  '瀬長島', '前島（沖縄）', '渡嘉敷島', '座間味島', '阿嘉島', '慶留間島', '粟国島', '渡名喜島', '久米島', '奥武島（久米島町）', 'オーハ島',
  '宮古島', '池間島', '大神島', '来間島', '伊良部島', '下地島', '多良間島', '水納島（多良間）', '石垣島', '竹富島', '小浜島', '嘉弥真島',
  '黒島（沖縄）', '新城島上地', '新城島下地', '西表島', '由布島', '鳩間島', '波照間島', '外離島', '与那国島'
]
