...
islands = [
  ...
  '黒島（松浦）', '飛島（長崎）', '青島（長崎）', '的山大島', '度島', '平戸島', '高島（平戸）', '生月島', '前島（佐世保）', '鼕泊島', '黒島（佐世保）',
  '高島（佐世保）', '針尾島', '大島（佐世保）', '竹ノ島', '鵜瀬島', '前島（時津）', '鹿島（長崎）', '大島（西海）', '寺島（西海）', '蛎浦島', '崎戸島',
  '江島（長崎）', '平島（長崎）', '南串島', '松島（長崎）', '池島', '伊王島', '沖之島（長崎）', '高島（長崎市）', '樺島', '牧島（長崎）', '宇久島',
  '寺島（佐世保）', '六島（長崎）', '野崎島', '納島', '小値賀島', '斑島', '黒島（小値賀）', '大島（小値賀）', '中通島', '頭ケ島', '桐ノ小島', '若松島',
  '漁生浦島', '有福島', '日ノ島', '奈留島', '前島（五島）', '久賀島', '蕨小島', '椛島', '福江島', '赤島（五島）', '黄島（長崎）', '黒島（五島）', '島山島（五島）', '嵯峨島',
